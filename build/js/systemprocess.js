class systemVisual {
    ...
    renderSystemMemory(data) {
        ...
        let totalmemory = Math.round(parseInt(data.system.totalmem) / 1048576);
        ...
        if(totalmemory > 1024){
            totalmemory = parseFloat(totalmemory / 1024).toFixed(2);
            usedmemory = parseFloat(usedmemory / 1024).toFixed(2);
            memoryscale = "Gb";
        }
